...
public class UI_pan_Liste_Fournisseur extends JPanel {
	...
	public static void setPanel(JPanel panel) {
		UI_pan_Liste_Fournisseur.panel = panel;
	}
	/**
	 * Create the panel.
	 */
	...
	public static void setTable(TableDark table) {
		UI_pan_Liste_Fournisseur.table = table;
	}
	public UI_pan_Liste_Fournisseur(String typeC) {
		...
		txt_recherche.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				collaborateur.afficheListe(table,Menu.getTypeCollaborateur(),txt_recherche.getText());
			}
		});
		txt_recherche.setForeground(Color.WHITE);
		txt_recherche.setFont(new Font("Arial", Font.PLAIN, 18));
